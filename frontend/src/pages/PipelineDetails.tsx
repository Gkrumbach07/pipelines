...
class PipelineDetails extends Page<{}, PipelineDetailsState> {
  ...
  public getInitialToolbarState(): ToolbarProps {
    ...
    const pipelineIdFromParams = (this.props.match.params as any)[RouteParams.pipelineId];
    const pipelineVersionIdFromParams = (this.props.match.params as any)[RouteParams.pipelineVersionId];
    ...
    if (origin) {
      ...
      return {
        ...
        pageTitle: (this.props.match.params as any)[RouteParams.pipelineId],
      };
    }
  }
  ...
  public async load(): Promise<void> {
    ...
    if (origin) {
      ...
      const pipelineId = (this.props.match.params as any)[RouteParams.pipelineId];
      const versionId = (this.props.match.params as any)[RouteParams.pipelineVersionId];
